...
export default function PrivacyPage() {
  return (
    ...
    >
      <p className={`-mt-8 text-sm ${body}`}>Effective date: September 24, 2026</p>
      ...
      <div id="owner-booking-alerts" className="scroll-mt-6">
        <LegalSection title="5A. SimplAssist Business Alerts">
          <p className="mb-4">Business account holders may separately opt in to receive automated texts from SimplAssist about confirmed bookings and sign-up links sent to callers. Sign-up-link alerts do not confirm delivery to the caller or completed registration. Entering a phone number during account registration or call-forwarding setup does not enroll you in this program. In Settings → Business alerts, you choose your mobile, agree to the SMS disclosure, and verify control of that mobile by sending the one-time verification text displayed in the form.</p>
          ...
          <p className="mb-4">Reply STOP to pause all SimplAssist business alerts to your mobile. You can also disable alerts for an individual business in Settings. Reply HELP for assistance or email {SUPPORT_EMAIL}. Message frequency varies with confirmed bookings and sign-up links sent. Message and data rates may apply.</p>
          <p>See <Link href="/booking-alerts" className={linkClass}>how business alerts work</Link> and the <Link href="/terms#owner-booking-alerts" className={linkClass}>business-alert SMS terms</Link>.</p>
        </LegalSection>
      </div>
